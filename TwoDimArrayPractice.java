   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   ...
	   for ( int row = 0; row < intArray.length; row++ )
       {
         if (minValue > intArray[row][column]) {
         minValue = intArray[row][column];
         animate( row, column, minValue );
         }
         // needed to create visual feedback
       }
       System.out.println( );
      return minValue; // replace this line with your return statement
   }
	   ...
	   for ( int row = 0; row < intArray.length; row++ )
	    {
	        for ( int column = 0; column < intArray[row].length; column++ )
	        {
	          ...
	          animate( row, column, frequencyCount );// needed to create visual feedback
	        }
	    }

     return frequencyCount; // replace this line with your return statement
   }
